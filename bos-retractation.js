...
(function () {
  ...
  // Partout ailleurs (accueil, contenus, calculateurs gratuits) : simple lien TEXTE
  // range dans le footer (l'obligation legale = information accessible, pas un
  // bouton flottant permanent). Boutons reels ici : .btn-buy (controle-argent,
  // pack-budget, bosBuyNow).
